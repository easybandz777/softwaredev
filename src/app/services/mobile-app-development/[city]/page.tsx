...
const CITIES: Record<string, CityConfig> = {
    "macon-ga": {
        ...
        faqs: [
            { q: "Do you meet with Macon clients in person?", a: "Yes. QuantLab USA is headquartered in Macon. On-site kickoffs across Bibb, Houston, Jones, and Monroe counties are standard — no travel premium." },
