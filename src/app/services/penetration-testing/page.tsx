            ...
            <div className="container mx-auto px-6 max-w-4xl">
                ...
                <AnimatedSection className="mb-16">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h2 className="text-2xl md:text-3xl font-bold text-white">Penetration Testing — Where We Serve</h2>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                        {pentestCities.map((c) => (
                            <Link
                                key={c.slug}
                                href={`/services/penetration-testing/${c.slug}`}
                                className="group flex items-center justify-between rounded-xl border border-white/5 bg-[#0d1526]/60 px-4 py-3 transition-all hover:border-red-400/30 hover:bg-[#0d1526]"
                            >
                                ...
                                <ArrowRight className="w-3.5 h-3.5 text-gray-600 group-hover:text-red-400 group-hover:translate-x-0.5 transition-all" />
                            </Link>
                        ))}
                    </div>
                </AnimatedSection>
