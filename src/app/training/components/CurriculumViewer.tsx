...
import { BookOpen, Target, Brain, Shield, Rocket, ArrowRight, PlayCircle, Lock, Presentation, Handshake, Zap, Trophy, Play } from "lucide-react";

interface CurriculumViewerProps {
    onStartTest: () => void;
}

export default function CurriculumViewer({ onStartTest }: CurriculumViewerProps) {

    return (
        <div className="relative min-h-screen text-[#f1f5f9] font-sans overflow-x-hidden selection:bg-cyan-500/30" style={{ background: "#05080f" }}>
            {/* Grid overlay */}
            ...
            {/* Premium Header Bar */}
            <header className="sticky top-0 z-50 backdrop-blur-xl bg-[#05080f]/80 border-b border-white/5 shadow-[0_4px_30px_rgba(0,0,0,0.5)]">
                <div className="max-w-4xl mx-auto px-6 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-cyan-400 to-purple-500 flex items-center justify-center p-[1px]">
                            <div className="w-full h-full bg-[#05080f] rounded-[7px] flex items-center justify-center">
                                <BookOpen className="w-4 h-4 text-cyan-400" />
                            </div>
                        </div>
                        <span className="font-semibold tracking-wide text-sm bg-clip-text text-transparent bg-gradient-to-r from-gray-200 to-gray-400">
                            QuantLab Elite Training
                        </span>
                    </div>

                    <button
                        onClick={onStartTest}
                        className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold text-[#05080f] hover:scale-105 active:scale-95 transition-all shadow-[0_0_20px_rgba(34,211,238,0.4)]"
            ...
            <main className="max-w-4xl mx-auto px-4 md:px-6 py-12 relative z-0">
                ...
                <div className="ql-card" style={{ marginBottom: '80px', background: 'linear-gradient(135deg, rgba(34,211,238,0.05), rgba(167,139,250,0.05))' }}>
                    ...
                    {/* Huge CTA to start the exam */}
                    <div className="mt-20 relative p-1 rounded-2xl overflow-hidden shadow-[0_0_40px_rgba(34,211,238,0.15)] group cursor-pointer" onClick={onStartTest}>
                        ...
                        <div className="absolute inset-0 bg-gradient-to-r from-[#22d3ee] to-[#a78bfa] blur-[20px] opacity-10 group-hover:opacity-40 transition-opacity duration-700" />

                        <div className="relative bg-[#0a0f1d] rounded-xl p-10 md:p-14 text-center border border-white/10 z-10 transition-transform duration-500 group-hover:scale-[0.99]">
                            <div className="w-20 h-20 mx-auto rounded-full bg-gradient-to-br from-[#22d3ee]/20 to-[#a78bfa]/20 border border-white/10 flex items-center justify-center mb-6 group-hover:rotate-12 transition-transform duration-500">
                                <Trophy className="w-10 h-10 text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400" />
                            </div>

                            <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-4 text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-200 to-gray-400">
                                Ready for the Standard?
                            </h2>
                            <p className="text-gray-400 max-w-xl mx-auto mb-10 text-lg">
                                You've internalized the playbooks, the psychology, and the elite tactics. Now it's time to prove it. Click below to begin the official 100-Question Qualification Exam.
                            </p>

                            <button
                                className="inline-flex flex-col items-center justify-center px-10 py-5 rounded-2xl font-bold tracking-wider uppercase transition-all overflow-hidden relative"
                                style={{
                                    background: "linear-gradient(135deg, rgba(34,211,238,0.1) 0%, rgba(167,139,250,0.1) 100%)",
                                    border: "1px solid rgba(255,255,255,0.1)"
                                }}
                            >
                                <span className="absolute inset-0 bg-gradient-to-r from-[#22d3ee] to-[#a78bfa] opacity-0 group-hover:opacity-20 transition-opacity duration-500" />
                                <span className="relative z-10 flex items-center gap-3 text-white text-lg md:text-xl">
                                    INITIATE CERTIFICATION EXAM <ArrowRight className="w-6 h-6 group-hover:translate-x-2 transition-transform" />
                                </span>
                            </button>
                        </div>
                    </div>
