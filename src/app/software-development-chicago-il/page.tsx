...
export const metadata = pageMetadata({
    title: "Chicago Software Development & Pen Testing | QUANT LAB USA",
    description:
        "Chicago software development for finance, logistics, and manufacturing — algorithmic trading systems, ops dashboards, and pen testing. Call (770) 652-1282.",
...
const breadcrumbSchema = {
    ...
    itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Software Development Chicago, IL", item: "https://quantlabusa.dev/software-development-chicago-il" },
    ],
};
            ...
            <div className="container mx-auto px-6 max-w-4xl">
                ...
                <AnimatedSection className="mb-16">
                    <RelatedPosts
                        ...
                        pinned={["build-vs-buy-software-2026","what-is-penetration-testing","building-multi-tenant-saas-postgres-rls"]}
                        heading="Reading for Chicago founders"
                    />
                </AnimatedSection>
