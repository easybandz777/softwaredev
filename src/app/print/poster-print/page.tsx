...
/* QuantLab Poster — 48×30in Landscape — PRINT-ONLY (no preview wrapper) */
...
export default function PosterPrintPage() {
  return (<>
    ...
    <div id="poster" style={ps}>
      ...
      {/* === FOREGROUND === */}
      <div style={{position:"relative",zIndex:10,height:"100%",display:"flex",flexDirection:"row",alignItems:"stretch",padding:".4in 1.4in"}}>

        {/* LEFT ZONE */}
        <div style={{flex:"0 0 38%",display:"flex",flexDirection:"column",justifyContent:"center",paddingRight:"1in"}}>
          <div style={{position:"relative",display:"inline-block",marginBottom:".15in",width:"fit-content"}}>
          ...
          <p style={{fontFamily:"'Space Grotesk',sans-serif",fontSize:".48in",fontWeight:600,color:S,margin:0,marginTop:".2in",
          ...
          <div style={{display:"flex",alignItems:"center",gap:".2in",marginTop:".15in"}}>
            <div style={{height:"1px",width:"1.5in",background:`linear-gradient(90deg,${C},transparent)`}}/>
          </div>
          <p style={{fontFamily:"'JetBrains Mono',monospace",fontSize:".24in",fontWeight:400,color:G,margin:0,marginTop:".1in",
